...
def gen(phrase, adjectives, w, h):
    ...
    with torch.inference_mode():
        ...
        for q in range(1):
            ...
            vaedecode_242 = vaedecode.decode(
                samples=get_value_at_index(ksampleradvanced_23, 0),
                vae=get_value_at_index(checkpointloadersimple_4, 2),
            )

            ultimatesdupscale_241 = ultimatesdupscale.upscale(
                upscale_by=3,
                ...
                image=get_value_at_index(vaedecode_242, 0),
                model=get_value_at_index(checkpointloadersimple_10, 0),
                positive=get_value_at_index(cliptextencodesdxl_75, 0),
                negative=get_value_at_index(cliptextencodesdxl_82, 0),
            ...
            saveimage_246 = saveimage.save_images(
                filename_prefix="ComfyUI",
                images=get_value_at_index(ultimatesdupscale_241, 0),
            )